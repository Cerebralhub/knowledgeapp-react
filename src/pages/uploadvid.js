               ...
               <div class="col-lg-12">
                  <div class="osahan-form">
                     <div class="row">
                        ...
                        <div class="col-lg-12">
                           <div class="form-group">
                              <label for="e2">Introduction</label>
                              <textarea rows="3" id="e2" name="e2" class="form-control">Short Description of the lesson</textarea>
                           </div>
                        </div>
                        <div class="col-lg-12">
                           <div class="form-group">
                              <label for="e2">Body</label>
                              <textarea rows="4" id="e2" name="e2" class="form-control">Explain in some detail the lesson </textarea>
                           </div>
                        </div>
                        <div class="col-lg-12">
                              <div class="form-group">
                                 <label for="e2">Conclusion</label>
                                 <textarea rows="3" id="e2" name="e2" class="form-control">Conclusion of the lesson</textarea>
                              </div>
                           </div>
                     </div>
                     <div class="row">
                        ...
                        <div class="col-lg-12">
                           <div class="form-group">
                              <label for="e3">For private Lessons input student email here</label>
                              <input type="text" placeholder="Student email" id="e3" class="form-control"/>
                           </div>
                        </div>
                     </div>
                     <div class="row">
